...
class ParametersHolderTest extends TestCase
{
    ...
    public function throwsExceptionWhenTryingToOverrideGlobalParameter(
    ): void {
    ...
    public function throwsExceptionWhenTryingToOverrideScopedParameter(
    ): void {
        $this->expectException(ParameterAlreadyDefinedException::class);
        $this->getService([
            new Parameter(
    ...
    #[Test]
    public function prioritizesScopedParametersOverGlobalParameters(
    ): void {
        $parameter = $this->getService([
            new Parameter(
